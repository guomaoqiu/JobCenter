...
# @Last Modified time: 2019-03-26 16:10:32
        ...
        for ret in ret_list:
            ...
            if  "cron" in str(ret.trigger):
                ...
                info = {
                    ...
                    'func':ret.func_ref,
                    'status':"<p style='background-color:#46c37b;color:snow'>Runing</p>" if ret.next_run_time != None else "<p style='background-color:#f0a63a;color:snow'>Pause</p>",
                    'cron':' '.join(cron_list)
                }
